...
3. (Optional) Record extras Excel doesn't hold — tickets, opponents, day results,
   emblems/medals — by editing [data/manual.js](data/manual.js). Everything there is
   optional; missing values simply display as "—".
